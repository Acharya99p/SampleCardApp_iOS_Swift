// Text field delegater and listener for texts

import Foundation
import UIKit

public final class Payment: NSObject, UITextFieldDelegate {
    public let creditCard: PaymentCreditCard
    ...
    public init(creditCard: PaymentCreditCard, flipOnClick: Bool = true) {
